...
const ResultForm = () => {
  ...
  const validate = () => {
    ...
    if (!formData.resultFile) newErrors.resultFile = "Result file is required";
    return newErrors;
  };
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      setSuccessMessage(`Result sent to ${formData.patientName} successfully!`);
      setSubmitted(true);
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-4 sm:p-6 lg:p-8">
        ...
        >
          ...
          {/* Result File */}
          <div>
            <label className="block text-sm font-medium mb-1">Upload Result</label>
            <input
              type="file"
              name="resultFile"
              ref={fileInputRef}
            ...
            />
            {errors.resultFile && (
              <p className="text-red-500 text-xs mt-1">{errors.resultFile}</p>
            )}
          </div>
          ...
          <div className="flex items-center">
            <input
              ...
              className="mr-2"
            />
            <label htmlFor="notifyByEmail" className="text-sm font-medium">
