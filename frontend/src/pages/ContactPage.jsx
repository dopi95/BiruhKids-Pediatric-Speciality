    ...
    <div className="flex flex-col">
      ...
      <section className="bg-[#007799] text-white text-center py-16 px-4">
        ...
        <p className="max-w-2xl mx-auto text-lg">
          ...
          with us for appointments, questions, or support.
        </p>
      </section>
      ...
      <section className="py-16 px-6 lg:px-20 grid lg:grid-cols-2 gap-12">
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
            ...
            {/* Subject */}
            <div>
              <label className="block mb-1 text-sm md:text-base">Subject</label>
              <input
                type="text"
                name="subject"
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-600 mb-6 text-sm md:text-base">
            ...
            experience. Whether you have questions about our services, need to
            schedule an appointment, or require emergency assistance, we're here
            to help.
          </p>
      ...
      <section className="py-16 px-6 lg:px-20 text-center">
        ...
        <div className="w-full h-96">
          {/* <iframe
            ...
            loading="lazy"
          ></iframe> */}
          <iframe title="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1970.3220851553685!2d38.71731500118866!3d9.004851719423158!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x164b85c434913883%3A0xf2ec78865f0cae3!2sBiruh%20Kids%20Pediatrics%20Speciality%20Clinic!5e0!3m2!1sen!2set!4v1756447113051!5m2!1sen!2set" 
            className="w-full h-full rounded-xl border-0 shadow-lg" allowfullscreen="" loading="lazy"></iframe>
        </div>
      </section>
    </div>
  );
