...
const translations = {
	...
	am: {
		contactTitle: "ያግኙን",
		contactDesc:
			"በሁሉም የጤና እንክብካቤ ፍላጎቶችዎ እርስዎን ለማገዝ እዚህ መጥተናል። ለቀጠሮዎች፣ ጥያቄዎች ወይም ድጋፍ እንዲያገኙ እባኮትን ከእኛ ጋር ይገናኙ።",
		...
		getInTouch: "ያግኙን",
		getInTouchDesc:
			"ከፍተኛ የጤና አገልግሎት ለእርስዎ ለማቅረብ ቆርጠን ተነስተናል። ስለአገልግሎታችን ጥያቄዎች ካልዎት፣ ቀጠሮ ማስያዝ ከፈለጉ፣ ወይም የአደጋ ጊዜ እርዳታ ከፈለጉ፣ እኛ ለመርዳት እዚህ ነን።",
		location: "አድራሻችን",
					...
					>
						<div className="flex items-start gap-3">
							...
							<div>
								...
								<p>
									Torhayloch, 100 meters from Augusta bridge
								</p>
