...
const AdminSidebar = () => {
    ...
    return (
        <>
            ...
            <div className="xl:hidden fixed top-0 left-0 w-full bg-gray-900 text-white flex items-center justify-between px-4 py-3 z-50">
        ...
        xl:translate-x-0`}
            >
                {/* Logo (Desktop only) */}
                <div className="hidden xl:flex xl:justify-between xl:items-center p-4 border-b border-gray-800">
                    <span className="text-lg font-bold">Admin Panel</span>
                    <div className="text-right">
                        <p className="text-sm font-medium text-gray-50">
                            {user?.name || 'Admin'}
                ...
                {/* Menu */}
                <nav className="flex-1 overflow-y-auto mt-14 xl:mt-0 pb-1 sm:pb-2">
                ...
                {/* Footer */}
                <div className="flex-shrink-0 p-3 border-t border-gray-800 space-y-1 xl:mb-2">
                    <Link
                        to="/"
            ...
            {/* Spacer for topbar (mobile/tablet only) */}
            <div className="xl:ml-80 mt-14 xl:mt-0"></div>
        </>
    );
};
